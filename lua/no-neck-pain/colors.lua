...
function C.init(win, side)
    ...
    local backgroundGroup =
        string.format("NoNeckPain_background_tab_%s_side_%s", S.getActiveTab(S), side)
    local textGroup = string.format("NoNeckPain_text_tab_%s_side_%s", S.getActiveTab(S), side)
